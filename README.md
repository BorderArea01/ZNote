<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/version-0.9.27-287464?style=flat-square" alt="Version 0.9.27" />
...
扩展 **0.9.14** 修复了批量入库只记录文字页码、实际没有成组的问题。Paw、普通扩展中的 Pixiv 和通用网页图集都提交作品组与页序，首张作封面；重试不会重复建组，已有手工分组与笔记配图归属保留。相同内容的多页保留各自位置，但共享原文件。更新时覆盖原扩展目录并重新加载，API 连接设置保留。
