<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/version-0.9.30-287464?style=flat-square" alt="Version 0.9.30" />
...
| 💬 微信收件 | 绑定个人微信收集入口，发送文字和图片自动入库；手机与服务器无需同一局域网，需账号支持 ClawBot |
...
| 图片 | 本地图片素材，自动添加「微信」及自定义标签 |
| 同条消息中的文字与图片 | 图文笔记，配图本地保存并成组 |
...
- 分开发送的消息分别入库，不按发送时间自动拼成一篇笔记。目前不接收群聊、语音、视频及其他文件消息。
