...
const captureRequest={type:"object",required:["text"],properties:{text:{type:"string",minLength:1,maxLength:16000},collection_id:{type:"string",nullable:true},tags:{type:"array",maxItems:20,items:{type:"string",maxLength:40}},request_id:{type:"string",pattern:"^[a-zA-Z0-9:_-]{1,160}$"}}};
