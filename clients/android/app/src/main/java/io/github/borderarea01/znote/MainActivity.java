...
public class MainActivity extends Activity {
    ...
    private void showConnect(String error){
        ...
        TextView logo=text("ZNote",36,Color.WHITE);logo.setTypeface(null,Typeface.BOLD);panel.addView(logo);panel.addView(text("连接你的私人知识库",21,Color.rgb(220,227,246)));panel.addView(button("? 连接说明",()->new AlertDialog.Builder(this).setTitle("连接知识库").setMessage("输入电脑或 NAS 上的 ZNote 地址，访问密码在连接后填写。手机和服务器需要网络可达，手机上的 localhost 不代表电脑。客户端不包含整库离线副本。").setPositiveButton("知道了",null).show()));
