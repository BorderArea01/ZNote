...
public class SmokeRunner extends Instrumentation {
    ...
    private void overlayTests()throws Exception{
        ...
        touchText("去浏览");nativeUntil(null,"我的知识库");shell("input keyevent 4");Thread.sleep(400);nativeUntil(fallback,"未读到本次分享链接");checkpoint("Floating save panel can open the library and return without discarding the pending share");
